...
Our company wants to partner with a film studio to make a high grossing movie. Looking at the data from our blockbuster csv file we are looking at the genre's, IMDB rating, length, movie rating (G, PG, PG-13, and R), studio, title, worldwide gross, and year. 

Our overarching question was:
What kind of movie should we make that has the potential to make the most money?

The other question we asked were:
...
Finally, what kind of movie should we make that has the potential to make the most money?
